...
var CordovaFacebook = (function() {
    ...
    exports.init = function(options) {
        ...
        exec(onSuccess, onFailure, SERVICE, INIT, []);
    };
    ...
    exports.invite = function(options) {
        ...
        exec(onSuccess, onFailure, SERVICE, INVITE, [options.appLinkUrl, options.appInvitePreviewImageURL]);
    };
    ...
    exports.share = function(options) {
        ...
        exec(onSuccess, onFailure, SERVICE, SHARE, [options.shareLinkUrl, options.title, options.description]);
    };
