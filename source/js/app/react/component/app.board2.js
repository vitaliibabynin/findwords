...
var BoardClass = Object.assign({}, {}, {
    ...
    openWord: function () {
        ...
        //if(!this.getNextUnopenedWord()){
        //    return;
        //}

        var word = this.getNextUnopenedWord();
    ...
    getNextUnopenedWord: function () {

        var wordsInLevel = this.state.board.words;

        var completedWords = this.state.completedWords;

        var WordToBeOpened = false;

        console.log(completedWords);

        //for (var i; i < completedWords.length; i++) {
        //    console.log(completedWords[i].length);
        //    console.log(completedWords[i]);
        //}

        completedWords.map(function (completedWord) {
            console.log(completedWord.length);
            console.log(completedWord);
        });

        wordsInLevel.map(function (wordObject) {

            console.log(wordObject.letters.length);
            wordObject.letters.map(function (lettersObject) {
        ...
        //wordsInLevel.map(function(wordInLevel, wilIdx, allWordsInLevel) {
        //
        //    wordInLevel.letters.map(function {})
        //    console.log(wordInLevel.letters);
        //
        //    var wordAlreadyOpened = false;
        //
        //    completedWords.map(function(completedWord, cwIdx, allCompletedWords) {
        //
        //        if (wordInLevel.letters.length == completedWord.length){
        //
        //            wordAlreadyOpened = true;
        //
        //            wordInLevel.map(function(letter, lidx, allLetters) {
        //
        //                console.log(letter);
        //
        //                if (letter[2] == completedWord[lidx][2]) {
        //
        //                    wordAlreadyOpened = false;
        //
        //                }
        //            })
        //        }
        //    });
        //
        //    if (!wordAlreadyOpened) {
        //        WordToBeOpened = wordsInLevel[wilIdx];
        //        return WordToBeOpened;
        //    }
        //
        //});
